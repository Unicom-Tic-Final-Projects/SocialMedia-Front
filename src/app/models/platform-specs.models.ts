...
export const PLATFORM_SPECS: Record<string, MediaFormat[]> = {
  instagram: [
    ...
    },
    {
      ...
      settings:
        'H.264 compression, square pixels, fixed frame rate, progressive scan and stereo AAC audio compression at 128kbps+.',
      notes:
        'Cover image should be same size. Reels appear as 1:1 in profile feed, 4:5 in home feed. Keep key elements centered.',
    },
  ],
  facebook: [
    {
  ...
  twitter: [
    ...
    },
    {
      ...
      fileSize: 'Up to 1GB',
      settings:
        'Audio codec: AAC LC (low complexity). Video codec recommendation: H264, Baseline, Main, or High Profile with a 4:2:0 color space.',
  ...
  youtube: [
    {
      ...
      settings:
        'MPEG-2 (Audio codec: MPEG Layer II or Dolby AC-3. Audio bitrate: 128 kbps or better), MPEG-4 (Video codec: H.264, Audio codec: AAC, Audio bitrate: 128 kbps or better)',
    ...
    },
    {
      ...
      fileSize: 'Up to 5MB',
      notes:
        'Have a resolution of 1280x720 (with a minimum width of 640 pixels). Remain under 2MB. Use a 16:9 aspect ratio.',
    },
  ],
  tiktok: [
    {
      ...
      notes:
        'Recommended size. Other dimensions will have black bars added for full-screen display.',
    },
    {
      name: 'In-Feed Ad',
      type: 'image',
      ...
      notes:
        'Vertical (9:16) is highly recommended for best performance. Aspect ratio is 16:9, 1:1 or 9:16.',
    },
  ],
};
