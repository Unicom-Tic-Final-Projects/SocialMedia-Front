...
export const routes: Routes = [
  ...
  { path: '', loadComponent: () => import('./dashboard/dashboard-layout/dashboard-layout').then(m => m.DashboardLayout), 
    children: [
      ...
      {
        path: 'social-account',
        loadComponent: () => import('./dashboard/social-account-page/social-account-page').then((m) => m.SocialAccountPage),
        children: [
          { path: 'connect', loadComponent: () => import('./dashboard/social-account-page/connect-account/connect-account').then((m) => m.ConnectAccount) },
          { path: 'success', loadComponent: () => import('./dashboard/social-account-page/auth-success/auth-success').then((m) => m.AuthSuccess) },
          { path: 'connected', loadComponent: () => import('./dashboard/social-account-page/connected-accounts/connected-accounts').then((m) => m.ConnectedAccounts) },
        ]
      },
    ]
  },
